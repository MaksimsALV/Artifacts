...
public class MinerController {
    ...
    public String start(@RequestParam String action,
        ...
        launcher.runMiner(action, activityLocation, utilityOne, utilityTwo, consumable, fightTask, miningAll, woodcuttingAll, fishingAll, herbsAll, craftingItem, craftingQuantity);
        return "redirect:/";
    }
