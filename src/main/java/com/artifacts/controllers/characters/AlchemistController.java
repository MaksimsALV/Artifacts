...
public class AlchemistController {
    ...
    public String start(@RequestParam String action,
        ...
        launcher.runAlchemist(action, activityLocation, utilityOne, utilityTwo, consumable, fightTask, miningAll, woodcuttingAll, fishingAll, herbsAll, craftingItem, craftingQuantity);
        return "redirect:/";
    }
