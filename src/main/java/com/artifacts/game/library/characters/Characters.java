...
public final class Characters {
    private Characters() {}
        private static final String WARRIOR = "Max"; //The Hero, also a blacksmith that crafts his own weapons and gear, also Miner as needed
        ...
        private static final String CHEF = "Sushimiko"; //Master Chef of these lands, the well known sushi expert. Incredible talented fisher-woman that cooks great fish dishes. As a Master-Chef, She knows how to kill small animals too, with her sharp knife! Can only wear cloth/leather only.
